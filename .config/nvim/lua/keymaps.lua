...
function M.apply_keymaps()
  ...
  vim.keymap.set('n', ',', ':normal gcl<CR>', { desc = 'Toggle comment' })
  ...
  vim.keymap.set('v', '<C-/>', ':normal gcl<CR>', { noremap = false, silent = true })
  vim.keymap.set('v', ',', ':normal gcl<CR>', { desc = 'Toggle comment' })
