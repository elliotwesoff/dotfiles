...
function M.apply_keymaps()
  ...
  vim.keymap.set('n', '<F10>', '<cmd>Glance definitions<CR>', opts)
  vim.keymap.set('n', '<F11>', '<CMD>Glance type_definitions<CR>')
  ...
  vim.keymap.set('n', '<leader><F12>', ':SymbolsOutline<CR>', opts)
  ...
  vim.keymap.set('n', '<leader><Tab>', ':SymbolsOutlineOpen<CR>', opts)
